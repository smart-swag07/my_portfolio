...
function downloadResume() {
  // Create resume content from your CV
  const resumeContent = `PRAJWAL M
==================
Email: prajjumss1234@gmail.com | Phone: +91 9481150220
Location: Mysuru, Karnataka
Portfolio: https://mysite07.netlify.app/
GitHub: github.com/smart-swag07
LinkedIn: linkedin.com/in/prajwal-m-8730b8284

PROFILE
-------
Final-year B.E. student in Computer Science (AIML) with hands-on experience in Python and foundational machine learning concepts through academic projects. Familiar with data preprocessing and basic model building. Interested in learning and applying AIML concepts in real-world software and data-driven applications.

EDUCATION
---------
B.E. in Computer Science & Engineering (AIML) | CGPA: 8.88/10
December 2022 - Present | Mysuru
...
PROJECTS
--------
1. AI-Powered Prompt Review & Enhancement System
   Created a web application to improve user text using AI API integration.

2. Raitha - AI-Powered Smart Farming Assistant
   Developed an application using Python for crop-related and weather-based information.

3. AI-driven Crop Disease Prediction and Management System
   Built an ML-based system for crop disease identification using Python and data preprocessing.

PUBLICATIONS
------------
• Context-Aware Machine Learning Model for Large-Scale Text Classification
  IEEE CONNECT 2025 | https://ieeexplore.ieee.org/abstract/document/11306727
...
-------------------------
• Logistics Head - IET: Contributed to smooth execution of college-level events
• Volunteer - Youth For Seva: Supported educational and community activities

AWARDS
------
• Best Volunteer Award - The Institution of Engineering and Technology (IET)
• Community Impact Award - The Institution of Engineering and Technology (IET)`;
  ...
  a.href = url;
  a.download = 'Prajwal_M_Resume.txt';
...
function previewResume() {
  const resumeContent = `
    <div style="font-family: 'Poppins', sans-serif; max-width: 800px; margin: 0 auto; padding: 30px; background: white; color: #333;">
      <h1 style="color: #6366f1; text-align: center; margin-bottom: 5px;">PRAJWAL M</h1>
      <div style="text-align: center; margin-bottom: 25px; color: #666;">
        <p>📧 prajjumss1234@gmail.com | 📞 +91 9481150220</p>
        <p>📍 Mysuru, Karnataka | 🔗 linkedin.com/in/prajwal-m-8730b8284</p>
        <p>🐙 github.com/smart-swag07 | 🌐 mysite07.netlify.app</p>
      </div>
      
      <div style="margin-bottom: 20px;">
        <h2 style="color: #6366f1; border-bottom: 2px solid #6366f1; padding-bottom: 5px;">PROFILE</h2>
        <p>Final-year B.E. student in Computer Science (AIML) with hands-on experience in Python and foundational machine learning concepts through academic projects. Familiar with data preprocessing and basic model building. Interested in learning and applying AIML concepts in real-world software and data-driven applications.</p>
      </div>
      
      <div style="margin-bottom: 20px;">
        <h2 style="color: #6366f1; border-bottom: 2px solid #6366f1; padding-bottom: 5px;">EDUCATION</h2>
        <p><strong>B.E. in Computer Science & Engineering (AIML)</strong> | CGPA: 8.88/10<br>
        December 2022 - Present | Mysuru</p>
      </div>
      
      <div style="margin-bottom: 20px;">
        <h2 style="color: #6366f1; border-bottom: 2px solid #6366f1; padding-bottom: 5px;">SKILLS</h2>
        <ul style="columns: 2;">
          <li><strong>Programming:</strong> Python, Java (Basic), C</li>
          <li><strong>Web & DB:</strong> HTML, CSS, SQL</li>
          <li><strong>ML Basics:</strong> Supervised & Unsupervised Learning</li>
          <li><strong>Data Tools:</strong> Pandas, Matplotlib, Excel, Power BI</li>
          <li><strong>Tools:</strong> Git, GitHub, Jupyter, VS Code, Google Colab</li>
        </ul>
      </div>
      
      <div style="margin-bottom: 20px;">
        <h2 style="color: #6366f1; border-bottom: 2px solid #6366f1; padding-bottom: 5px;">PROJECTS</h2>
        <p><strong>• AI-Powered Prompt Review & Enhancement System:</strong> Web app using AI API integration</p>
        <p><strong>• Raitha - Smart Farming Assistant:</strong> Python app for crop-related information</p>
        <p><strong>• AI-driven Crop Disease Prediction:</strong> ML-based disease identification system</p>
      </div>
      
      <div style="margin-bottom: 20px;">
        <h2 style="color: #6366f1; border-bottom: 2px solid #6366f1; padding-bottom: 5px;">PUBLICATIONS</h2>
        <p><strong>IEEE CONNECT 2025:</strong> Context-Aware Machine Learning Model for Large-Scale Text Classification</p>
      </div>
      
      <div style="margin-bottom: 20px;">
        <h2 style="color: #6366f1; border-bottom: 2px solid #6366f1; padding-bottom: 5px;">CERTIFICATIONS</h2>
        <ul style="columns: 2;">
          <li>NVIDIA - LLM Applications</li>
          <li>IBM - AI Fundamentals</li>
          <li>IBM - Python for Data Science</li>
          <li>JPMorgan Chase - Excel Skills</li>
          <li>Infosys - Deep Learning</li>
          <li>AWS - Solutions Architecture</li>
        </ul>
      </div>
      
      <div style="margin-bottom: 20px;">
        <h2 style="color: #6366f1; border-bottom: 2px solid #6366f1; padding-bottom: 5px;">LEADERSHIP & AWARDS</h2>
        <p><strong>• IET Logistics Head:</strong> Coordinated college events</p>
        <p><strong>• Youth For Seva Volunteer:</strong> Educational activities</p>
        <p><strong>• Awards:</strong> Best Volunteer Award, Community Impact Award (IET)</p>
      </div>
      
      <div style="text-align: center; margin-top: 30px; color: #888; font-size: 12px;">
        <p>© 2025 Prajwal M. All rights reserved.</p>
      </div>
    </div>
  `;
    ...
    <html>
      ...
      <body>
        ...
        <div style="text-align: center; margin: 20px;">
          <button onclick="window.print()" style="background: #6366f1; color: white; border: none; padding: 12px 30px; border-radius: 8px; font-size: 16px; font-weight: 600; cursor: pointer;">🖨️ Print Resume</button>
        </div>
      </body>
    </html>
  `);
